              ...
              <div className="pricing14-price10">
                <div className="pricing14-price11">
                  ...
                  <p className="thq-body-large">
                    {props.plan1Yearly ?? (
                      <Fragment>
                        <span className="pricing14-text199">$99/year</span>
                      </Fragment>
                    )}
                  </p>
                </div>
              ...
              <div className="pricing14-price12">
                <div className="pricing14-price13">
                  ...
                  <p className="thq-body-large">
                    {props.plan2Yearly ?? (
                      <Fragment>
                        <span className="pricing14-text168">$199/year</span>
                      </Fragment>
                    )}
                  </p>
                </div>
                      ...
                      {props.plan2Feature1 ?? (
                        <Fragment>
                          <span className="pricing14-text179">
                            Up to 20 simulations per month
                          </span>
                        </Fragment>
                      )}
                    </span>
              ...
              <div className="pricing14-price14">
                <div className="pricing14-price15">
                  ...
                  <p className="thq-body-large">
                    {props.plan3Yearly ?? (
                      <Fragment>
                        <span className="pricing14-text194">$299/year</span>
                      </Fragment>
                    )}
                  </p>
                </div>
